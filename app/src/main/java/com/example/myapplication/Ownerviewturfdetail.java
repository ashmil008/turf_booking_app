...
public class     Ownerviewturfdetail extends AppCompatActivity  implements AdapterView.OnItemClickListener  {
    GridView gv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url ="http://"+ip+":5000/owneruniqueturf";


        // Instantiate the RequestQueue.
        RequestQueue queue = Volley.newRequestQueue(Ownerviewturfdetail.this);
...
//                        fimg.add(jo.getString("fimage"));
                    ...
                    gv.setOnItemClickListener(Ownerviewturfdetail.this);
...
//                    lv.setAdapter(ad);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent ik=new Intent(getApplicationContext(),Turfviewowner.class);
