...
public class TurfSignup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turf_signup);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tname.equalsIgnoreCase("")) {
                    e1.setError("Plaese enter turf name");
                    e1.requestFocus();
                } else if (place.equalsIgnoreCase("")) {
                    e2.setError("Please enter place");
                    e2.requestFocus();
                } else if (landmark.equalsIgnoreCase("")) {
                    e3.setError("Required");
                    e3.requestFocus();
                } else if (Contact_no.equalsIgnoreCase("")) {
                    e4.setError("Enter your contact details");
                    e4.requestFocus();
                ...
                else if (!Patterns.EMAIL_ADDRESS.matcher(Email).matches())
                {
                    ...
                    try {
                        ...
                        String resp = json.getString("task");
...
//
    ...
    public String uploadFile(String sourceFileUri) {
        try {
            ...
            String upLoadServerUri = "http://" + sp.getString("ip", "") + ":5000/signupturf";
