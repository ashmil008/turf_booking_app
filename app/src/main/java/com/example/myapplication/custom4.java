...
public class custom4 extends BaseAdapter{
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        TextView tv1=(TextView)gridView.findViewById(R.id.turfs);
        TextView tv2=(TextView)gridView.findViewById(R.id.place);
        TextView tv3=(TextView)gridView.findViewById(R.id.date);
        TextView tv4=(TextView)gridView.findViewById(R.id.slt);
